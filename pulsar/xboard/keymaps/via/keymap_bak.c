...
bool rgb_matrix_indicators_user(void)  {
    ...
    if (isWinLock){         // WIN key Lock LED Blink
        ...
        // }
        // if (isWinLockLedOn) {
            if (isMacMode) win_key_locked = false;      // rgb_matrix_set_color(100, Status_LED_Bright_value, Status_LED_Bright_value, Status_LED_Bright_value);
