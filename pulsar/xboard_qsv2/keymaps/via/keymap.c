...
*/
    ...
    /* Keymap _FN: Function Layer
     ...
     [WIN_FN] = LAYOUT_all(/* Function Layer */
        ...
        _______, KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_D, _______, _______, _______, _______, _______, _______, QK_BOOT, _______,    _______,                                   KC_MS_L, KC_BTN3, KC_MS_R,
...
bool rgb_matrix_indicators_user(void)  {
    ...
    if (win_key_locked){         // WIN key Lock LED Blink
            if (isMacMode) {
